 ...
 * Generated at: 2021-05-18 11:32:52 UTC
...
public final class boardListView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/board/../common/menubar.jsp", Long.valueOf(1621250346625L));
  }
 ...
 if(p != currentPage){ 
      ...
      out.write(" <!-- 지금 보고있는 페이지일 경우 클릭이 되지 않게 설정 -->\r\n");
 ...
 if(currentPage != maxPage){ 
      ...
      out.write("        \r\n");
      out.write("        \r\n");
      out.write("        <div style=\"display:none\"> <!-- 내가 해본거,, -->\r\n");
      out.write("        \t");
 if(pi.getStartPage() != 1){ 
      out.write(" <!-- 왼쪽버튼 눌렀을때 빈페이지가 뜨지 않도록 조건설정 -->\r\n");
      out.write("            \t<button> <a href=\"");
      out.print(contextPath + "/list.bo?currentPage=" + (pi.getStartPage() - 1));
      out.write("\">&lt;</a> </button>\r\n");
      out.write("            ");
 } else { 
      out.write("\r\n");
      out.write("            \t<button> <a href=\"");
      out.print(contextPath + "/list.bo?currentPage=" + (pi.getStartPage()));
      out.write("\">&lt;</a> </button>\r\n");
      out.write("            ");
 } 
      out.write("\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<!-- 최대 페이징 수(10) 만큼 버튼이 반복되게 하기 -->\r\n");
      out.write("\t\t\t");
 for(int i=pi.getStartPage(); i<=pi.getEndPage(); i++){ 
      out.write(" \r\n");
      out.write("            \t<button><a href=\"");
      out.print(contextPath + "/list.bo?currentPage=" + i);
      out.write('"');
      out.write('>');
      out.print(i);
      out.write("</a></button>\r\n");
      ...
      out.write("            \r\n");
      out.write("            ");
 if((pi.getEndPage()+1) <= pi.getMaxPage()){ 
      out.write(" <!-- 오른쪽버튼 눌렀을때 빈페이지가 뜨지 않도록 조건설정 -->\r\n");
      out.write("            \t<button> <a href=\"");
      out.print(contextPath + "/list.bo?currentPage=" + (pi.getEndPage() + 1));
      out.write("\"> &gt; </a> </button>\r\n");
      out.write("            ");
 } else { 
      out.write(" \r\n");
      out.write("\t\t\t\t<button> <a href=\"");
      out.print(contextPath + "/list.bo?currentPage=" + (pi.getEndPage()));
      out.write("\"> &gt; </a> </button>\r\n");
      out.write("\t\t\t");
 } 
      out.write("\r\n");
