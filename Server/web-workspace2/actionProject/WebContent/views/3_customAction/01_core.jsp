...
<body>
	...
	* 주의사항
	...
	${ requestScope.result } <br> <%-- request Scope에 존재X => null(X), 빈칸(O) --%>
	...
	* 변수 삭제 (c:remove var="제거하고자하는변수명" [scope=""])
	...
	<pre>
	* 변수(데이터) 출력(c:cout value="출력하고자하는값" [default="기본값"] [escapeXml="true|false"])
	...
	향상된 for문  - (c:forEach var="변수명" items="순차적으로접근할객체(배열또는컬렉션)" [varStatus="현재접근된요소의 상태값을 보관할 변수명"])
	</pre>
