...
<body>
	<!-- 
		* 프레임워크
		...
		- 소프트웨어 개발의 입장으로서는 공통으로 사용하는 라이브러리 / 개발도구 / 인터페이스 등등을 의미
		...
		* 프레임워크의 특징
		- 자유롭게 설계하고 코딩하는게 아니라 프레임워크가 제공하는 "가이드"대로 설계하고 코딩해야됨 (세팅도)
		- 개발할 수 있는 범위가 정해져있음 (한정적이긴 하지만 범위가 아주 !!! 넓어서 제한적이지 않다.)
		...
		* 프레임워크의 장단점
		...
		> 단점
		  - 너무 의존하다보면 개발능력이 떨어져서 프레임워크 없이 개발하는 것이 어려워짐
