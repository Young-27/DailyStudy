 ...
 * Generated at: 2021-06-09 06:03:24 UTC
...
if(memcode==1){ 
 ...
 if(memcode==1){ 
      ...
      out.write("    \r\n");
      out.write("        <br>\r\n");
      out.write("        <div data-text-content=\"true\" style=\"font-size: 16px; font-weight: bold; color: rgb(127, 127, 127);\" class=\"text-left\" spellcheck=\"false\">통합 관리&gt; 신고 조회</div>\r\n");
      out.write("        <div data-text-content=\"true\" style=\"font-weight: bold; font-size: 32px; color: rgb(127, 127, 127);\" class=\"text-left\" spellcheck=\"false\">신고 조회</div>\r\n");
      out.write("        <br>\r\n");
      out.write("        \r\n");
      out.write("        <div class=table-responsive-sm>\r\n");
      out.write("\t        <table border=\"1\" class=\"list-area table table-bordered\" align=\"center\">\r\n");
      out.write("\t        \t");
 if(list.isEmpty()){ 
      out.write("\r\n");
      out.write("\t\t            <tr>\r\n");
      out.write("\t\t                <td colspan=\"6\">조회할 데이터가 없습니다.</td>\r\n");
      out.write("\t\t            </tr>\r\n");
      out.write("\t            ");
 }else{ 
      out.write("\r\n");
      out.write("\t\t            <thead class=\"thead-light text-center\">\r\n");
      out.write("\t\t            \t<tr>\r\n");
      out.write("\t\t\t                <th>No</th>\r\n");
      out.write("\t\t\t                <th>신고자 아이디</th>\r\n");
      out.write("\t\t\t                <th>게시판 이름</th>\r\n");
      out.write("\t\t\t                <th>제목</th>\r\n");
      out.write("\t\t\t                <th>신고 사유</th>\r\n");
      out.write("\t\t\t                <th>신고 날짜</th>\r\n");
      out.write("\t\t            \t</tr>\r\n");
      out.write("\t\t            </thead>\r\n");
      out.write("\t\t            \r\n");
 ...
 for(Report r : list){ 
      out.write("\r\n");
      out.write("\t\t\t\t            <tr>\r\n");
      out.write("\t\t\t\t            \t<input type=\"hidden\" class=\"refNo\" value=\"");
      out.print(r.getRefNo() );
      out.write("\">\r\n");
      out.write("\t\t\t\t                <td>");
      out.print(r.getReportUnique() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t                <td>");
 ...
 if(r.getRefBoardType().equals("POST")){ 
      ...
      out.write("\t\t\t\t                \t\t<td>");
      out.print(r.getCpostTitle() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t                \t");
 }else if(r.getRefBoardType().equals("ANIMAL")){ 
      out.write("\r\n");
      out.write("\t\t\t\t                \t\t<td>보호중인 아이들</td>\r\n");
      out.write("\t\t\t\t                \t\t<td>");
      out.print(r.getAnimalTitle() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t                \t");
 }else if(r.getRefBoardType().equals("ADOPT")){ 
      out.write("\r\n");
      out.write("\t\t\t\t                \t\t<td>입양 후기</td>\r\n");
      out.write("\t\t\t\t                \t\t<td>");
      out.print(r.getAdoptTitle() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t                \t");
      ...
      out.write("\t\t\t\t                \t\t<td>후원</td>\r\n");
      out.write("\t\t\t\t                \t\t<td>");
      out.print(r.getDonationTitle() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t                \t");
 }else if(r.getRefBoardType().equals("VOLUNTEER")){ 
      out.write("\r\n");
      out.write("\t\t\t\t                \t\t<td>자원봉사</td>\r\n");
      out.write("\t\t\t\t                \t\t<td>");
      out.print(r.getVolunteerTitle() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t                \t");
 } else {
      out.write("\r\n");
      ...
      out.write("\t          \t\t\tvar refType = $(this).children().eq(3).text();\r\n");
      out.write("\t          \t\t\tconsole.log(refType);\r\n");
      out.write("\t\t      \t\t\tvar refNo = $(this).children(\".refNo\").val();\r\n");
      out.write("\t\t      \t\t\tconsole.log(refNo);\r\n");
      out.write("\t          \t\t\tif(refType == \"자유게시판\"){\r\n");
      out.write("\t          \t\t\t\tlocation.href = \"");
      out.print(contextPath);
      out.write("/detail.cp?cno=\" + refNo;\r\n");
      out.write("\t          \t\t\t}else if(refType == \"보호중인 아이들\"){\r\n");
      out.write("\t          \t\t\t\tlocation.href = \"");
      out.print(contextPath);
      out.write("/detail.an?ano=\" + refNo;\r\n");
      out.write("\t          \t\t\t}else if(refType == \"입양 후기\"){\r\n");
      out.write("\t          \t\t\t\tlocation.href = \"");
      out.print(contextPath);
      out.write("/detail.ad?ano=\" + refNo;\r\n");
      out.write("\t          \t\t\t}else if(refType == \"후원\"){\r\n");
      out.write("\t          \t\t\t\tlocation.href = \"");
      out.print(contextPath);
      out.write("/detail.do?dno=\" + refNo;\r\n");
      out.write("\t          \t\t\t}else if(refType == \"자원봉사\"){\r\n");
      out.write("\t          \t\t\t\tlocation.href = \"");
      out.print(contextPath);
      out.write("/detail.vo?vno=\" + refNo;\r\n");
      out.write("\t          \t\t\t}\r\n");
      out.write("\t          \t\t})\r\n");
      out.write("\t          \t})\r\n");
      out.write("\t\t</script>\r\n");
      ...
      out.write("\t\t\t페이징바--------------------------------------------------------------------------------------- \r\n");
      out.write("\t\t-->\r\n");
      out.write("\t\t<div align=\"center\" class=\"paging-area text-center\">\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t  <ul class=\"pagination justify-content-center\" align=\"center\">\r\n");
      out.write("\t\t\t  \t");
 if(currentPage != 1){ 
      out.write("\r\n");
