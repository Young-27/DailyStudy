 ...
 * Generated at: 2021-06-09 06:06:13 UTC
...
if(memcode==1){ 
 ...
 if(memcode==1){ 
      ...
      out.write("\t\t<br>\r\n");
      out.write("        <div data-text-content=\"true\" style=\"font-size: 16px; font-weight: bold; color: rgb(127, 127, 127);\" class=\"text-left\" spellcheck=\"false\">통합 관리&gt; 게시판 글 조회</div>\r\n");
      out.write("        <div data-text-content=\"true\" style=\"font-weight: bold; font-size: 32px; color: rgb(127, 127, 127);\" class=\"text-left\" spellcheck=\"false\">게시판 글 조회</div>\r\n");
      out.write("        <!-- \r\n");
      out.write("\t\t\t게시판 글 검색기능--------------------------------------------------------------------------------------- \r\n");
      out.write("\t\t    http://localhost:8888/conimal/list.me?search_op=id&keyword=dd\r\n");
      out.write("\t\t-->\r\n");
      out.write("\t\t<nav class=\"navbar navbar-dark justify-content-center\">\r\n");
      out.write("\t\t\t<form class=\"form-inline\" action=\"");
      out.print(contextPath);
      out.write("/listSearch.bo\" method=\"post\">\r\n");
      out.write("\t\t\t\t<div class=\"search\">\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"currentPage\" value=\"1\">\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"keyword\" class=\"form-control mr-sm-2\" placeholder=\"검색할 게시글 제목을 입력하세요.\" value=\"");
if(keyword!=null){ 
      out.print(keyword);
}
      out.write("\" style=\"width:500px\">\r\n");
      out.write("\t\t\t\t\t<button class=\"btn\" type=\"submit\" style=\"background-color: rgb(187, 208, 227)\">검색</button>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t</nav>\r\n");
      out.write("        \r\n");
...
if(searchList.isEmpty()){ 
 ...
 if(b.getbRefType().equals("POST")){ 
      ...
      out.write("\t          \r\n");
      out.write("\t          <script>\r\n");
      out.write("\t          \t$(function(){ // 자유게시판이면 => / 보호중인아이들이면 => \r\n");
      out.write("\t          \t\t$(\".list-area>tbody>tr\").click(function(){\r\n");
      out.write("\t          \t\t\tvar refType = $(this).children().eq(1).text();\r\n");
      ...
      out.write("\t          \t\t\t\tlocation.href = \"");
      out.print(contextPath);
      out.write("/detail.an?ano=\" + $(this).children().eq(0).text();\r\n");
 ...
 if(currentPage != 1){ 
      ...
      out.print(contextPath);
      out.write("/listSearch.bo?currentPage=");
